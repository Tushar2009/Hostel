        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Trainee Registration Form</h4>
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Order ID</h4>
                                        <div class="form-group">
                                            <input type="text" name="regno" placeholder="Enter Order Id" id="regno" class="form-control" required>
                                        </div>
