                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            ...
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="../assets/images/download.png" alt="homepage" class="dark-logo" width="180" height="120"/>
                                <!-- Light Logo text -->
                                <img src="../assets/images/download.png" class="light-logo" alt="homepage" width="180" height="120"/>
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
