<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query="INSERT into  registration(roomno,foodstatus,stayfrom,duration,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresPincode,pmntAddress,pmntCity,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        $stmt = $mysqli->prepare($query);
        $rc=$stmt->bind_param('iisisssssisissississi',$roomno,$foodstatus,$stayfrom,$duration,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cpincode,$paddress,$pcity,$ppincode);
        $stmt->execute();
...
<!-- By CodeAstro - codeastro.com -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <code></code></label>
                                </div>
                                <div class="custom-control custom-radio">
                ...
                <h4 class="card-title mt-5">Trainee's Personal Information</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Relation</h4>
                                        <div class="form-group">
                                            <input type="text" name="grelation" id="grelation" required class="form-control" placeholder="Trainee's Relation with Guardian">
                                        </div>
                                </div>
                            </div>
                        </div>
